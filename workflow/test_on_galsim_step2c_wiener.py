#!/usr/bin/env python3
"""Step 2c: run Wiener deconvolution inference on val and GalSim datasets and save artifacts."""
...
def _parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Run Wiener deconvolution inference for test_on_galsim and save artifacts.")
